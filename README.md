...
Práctica:
– Montaje del entorno
– Carga de un modelo base open source
– Primeros prompts controlados y análisis de fallos
...
Práctica:
– Creación de un pequeño dataset de instrucciones
– Entrenamiento SFT + LoRA sobre un modelo base
– Comparativa entre modelo base y ajustado
...
– Indexación de documentos reales
– Integración del modelo fine-tuned con RAG
– Tests de preguntas con y sin RAG y análisis de resultados
...
Práctica:
– Definición de tools personalizadas
– Ejecución condicional de funciones
– Integración tools + RAG
– Casos donde el modelo decide no responder sin información
...
Práctica:
– Implementación de un agente sencillo
– Uso de memoria a corto y largo plazo
– Control de pasos y prevención de bucles
– Agente integrado con tools y RAG
...
Práctica:
– Creación de un set de evaluación
...
Práctica:
– Exposición del sistema vía API
– Simulación de carga básica
– Checklist de producción

Proyecto final integrador (opcional repartido durante el curso)
Resultado final:
...
Bloque 1. Baseline controlado y diagnóstico
...
Bloque 2. Fine-tuning con SFT + LoRA
...
Bloque 3. RAG serio, no decorativo
...
Bloque 4. Tools y detección de ignorancia
